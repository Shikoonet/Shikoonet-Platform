...
export const TEXTS = {
  ...
  // account vanished with no reason writes to support and a customer who is
  // told «۳۰ روز از انقضایش گذشته بود» does not.
  CRON_SERVICE_REMOVED: {
    default:
      '🗑 سرویس «{plan}» از پنل حذف شد.\n\n{days} روز از تاریخ انقضایش گذشته بود. برای گرفتن سرویس تازه از منوی خرید اقدام کنید.',
    placeholders: ['plan', 'days'],
    screen: 'warnings',
  ...
  // Nobody's service is touched by this one — it goes to a person who has never
  // bought anything. Mirzabot has the same audience (`admin.php:1247`,
