...
export const TEXTS = {
  ...
  PAID_WITHDRAWN_TITLE: {
    default:
      '↩️ ثبت پرداخت پس گرفته شد. اگر می‌خواهید بخرید، دوباره سرویس را انتخاب کنید تا فاکتور تازه صادر شود.',
    placeholders: [],
    screen: 'paid',
    hint: 'بعد از زدن «پرداختی نکردم» روی ثبت پرداختی که رسید نداشت',
  },
  PAID_HAS_EVIDENCE: {
    default:
