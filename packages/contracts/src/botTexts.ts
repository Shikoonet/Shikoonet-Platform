...
export const TEXTS = {
  ...
  /**
   * Legacy's `renewReportAdminFn` plus one line it never had: what the account
   * WAS before this renewal — Sam, 2026-09-20: «اکانت قبلیش چی بوده و الان به
   * چی تبدیل شده». The «نام محصول» lines below it are the new service.
   */
  REPORT_RENEWAL: {
    default:
      '📣 جزئیات تمدید اکانت در ربات شما ثبت شد .\n    \n▫️آیدی عددی کاربر : {telegramId}\n▫️نام کاربری کاربر : @{username}\n▫️نام کاربری کانفیگ :{config}\n▫️موقعیت سرویس سرویس : {panel}\n▫️سرویس قبلی : {previousPlan} — {previousVolume} GB — انقضا {previousExpiry}\n▫️نام محصول : {plan}\n▫️حجم محصول : {volume}\n▫️زمان محصول : {days}\n▫️مبلغ تمدید : {price} تومان\n▫️موجودی قبل از خرید : {balanceBefore} تومان\n▫️زمان خرید : {time}',
    placeholders: ["telegramId", "username", "config", "panel", "previousPlan", "previousVolume", "previousExpiry", "plan", "volume", "days", "price", "balanceBefore", "time"],
    screen: 'warnings',
