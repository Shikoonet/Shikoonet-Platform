...
export const TEXTS = {
  ...
  CHOOSE_PRODUCT: {
    ...
    placeholders: [],
    screen: 'products',
    hint: 'فقط از دکمه‌های `panel:` که در چت‌های قبلی مانده‌اند — صفحهٔ سرویس‌ها که از دسته‌بندی باز می‌شود متن CATEGORY_PLANS را می‌گیرد، چون نام دسته را هم نشان می‌دهد',
  },
  PANEL_EMPTY: {
  ...
  PLAN_OUT_OF_STOCK_TAG: {
    ...
    placeholders: [],
    screen: 'plans',
    hint: 'پسوند دکمهٔ پلنی که از قفسهٔ انبار فروخته می‌شود و قفسه‌اش خالی است',
  },
  PLAN_OUT_OF_STOCK: {
    default:
      '⏳ این سرویس فعلاً موجود نیست.\n\nبه‌محض شارژ شدن انبار می‌توانید آن را بخرید؛ تا آن وقت مبلغی از شما گرفته نمی‌شود.',
    placeholders: [],
    screen: 'planDetail',
    hint: 'وقتی مشتری پلنی را می‌زند که از قفسه فروخته می‌شود و قفسه خالی است — فاکتوری ساخته نمی‌شود',
  },
  ...
  CHECKOUT_VALID_UNTIL: {
    default: '⏳ این فاکتور و شمارهٔ کارت فقط تا ساعت {time} معتبر است؛ بعد از آن به این کارت واریز نکنید.',
    placeholders: ['time'],
    screen: 'checkout',
    hint: 'مهلت فاکتور به وقت تهران — همان «مهلت پرداخت فاکتور و نگه‌داشتن کارت» در تنظیمات؛ بعدش کارت به مشتری بعدی می‌رسد',
  },
  CHECKOUT_COPY_CARD: {
  ...
  CHECKOUT_COPY_AMOUNT: {
    ...
    placeholders: [],
    screen: 'checkout',
    hint: 'دکمه‌ای که مبلغ را به ریال و بدون جداکننده کپی می‌کند — همان عددی که در اپ بانک وارد می‌شود',
  },
  ORDER_GONE: {
  ...
  ORDER_DEADLINE_CLAIMED_TITLE: {
    default: '⌛ مهلت این فاکتور تمام شد و شمارهٔ کارت روی آن دیگر معتبر نیست.',
    placeholders: [],
    screen: 'checkout',
    hint: 'خط اول پیامی که سر مهلت جای فاکتوری می‌نشیند که مشتری روی آن «پرداخت کردم» زده ولی پولش هنوز نرسیده',
  },
  ORDER_DEADLINE_CLAIMED_BODY: {
    default:
      'اگر واریز کرده‌اید، پرداختتان در صف بررسی است و پس از تایید، سرویس تحویل می‌شود. اگر واریز نکرده‌اید، به این کارت واریز نکنید و از منوی اصلی دوباره خرید کنید.',
    placeholders: [],
    screen: 'checkout',
    hint: 'دنبالهٔ همان پیام — پرداختِ ادعاشده گم نمی‌شود، فقط کارت به مشتری بعدی می‌رسد',
  },
  ...
  RENEW_MODE_RESET: {
    default: '⚠️ با تمدید، زمان و حجم از نو شروع می‌شود و مصرف قبلی صفر می‌گردد.',
    placeholders: [],
    screen: 'renew',
    hint: 'پنلی که تمدید را از نو شروع می‌کند',
  },
  RENEW_MODE_ADD_VOLUME_RESET_TIME: {
    default: '⚠️ با تمدید، زمان از نو شروع می‌شود و حجم تازه به حجم باقی‌مانده اضافه می‌گردد.',
    placeholders: [],
    screen: 'renew',
  ...
  RENEW_CHOOSE_TIER: {
    default: '🛍 سطح سرویس را انتخاب کنید — می‌توانید همین سطح را نگه دارید یا به سطح دیگری بروید:',
    placeholders: [],
    screen: 'renew',
    hint: 'خط آخر صفحهٔ تمدید، وقتی پنل بیش از یک سطح (الماس، طلایی…) دارد و هر سطح دکمهٔ خودش را دارد',
  },
  RENEW_WRONG_FAMILY: {
    default: 'این پلن برای نوع سرویس شما نیست.\n\nاز فهرست تمدید، یکی از سطح‌های همین سرویس را انتخاب کنید.',
    placeholders: [],
    screen: 'renew',
    hint: 'وقتی دکمه‌ای پلنی از نوع دیگر (مثلاً اسپاتیفای برای سرویس VPN) را روی این سرویس بزند',
  },
  ...
  REFERRAL_TERMS: {
    default:
      'هر کسی با لینک شما وارد شود، از «اولین خرید» او {percent}٪ و از «هر تمدید» یا «خرید بعدی» او {renewPercent}٪ به کیف پول شما اضافه می‌شود.',
    placeholders: ['percent', 'renewPercent'],
    screen: 'referral',
    hint: 'شرح پورسانت — {percent} درصد خرید اول، {renewPercent} درصد هر تمدید و هر خرید بعدی',
  },
  REFERRAL_INVITED: {
  ...
  RESELLER_SALE_OFF: {
    default: '🛒 خرید حجم برای این پنل هنوز فعال نشده است. برای فعال‌شدنش با پشتیبانی در تماس باشید.',
    placeholders: [],
    screen: 'reseller',
    hint: 'وقتی برای این پنل «فروش به نماینده» (جدول قیمت) در داشبورد تنظیم نشده',
  },
  RESELLER_PANEL_GONE: {
