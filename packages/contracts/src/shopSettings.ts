...
const TYPED_OUT_SETTINGS = [
  ...
  },
  {
    ...
    hint: 'کارتی که روی فاکتور چاپ شد، این‌قدر دقیقه به کس دیگری داده نمی‌شود و فاکتور هم همین‌قدر معتبر است؛ اگر تا آن موقع «پرداخت کردم» نزده باشد، فاکتور منقضی و کارت آزاد می‌شود. کمتر از ۱ پذیرفته نمی‌شود و ۱۰ فرض می‌شود.',
    kind: 'int',
  },
  {
    scope: 'bot',
