...
const TYPED_OUT_SETTINGS = [
  ...
  },
  {
    ...
    label: 'مدت نگه‌داشتن کارت برای هر فاکتور (دقیقه)',
    hint: 'کارتی که به یک مشتری نشان داده شد، این‌قدر دقیقه به کس دیگری داده نمی‌شود؛ اگر تا آن موقع «پرداخت کردم» نزده باشد، آزاد می‌شود. ۰ یعنی بدون نگه‌داشتن.',
    kind: 'int',
  },
  {
    scope: 'bot',
