...
const TYPED_OUT_SETTINGS = [
  ...
  },
  {
    ...
    hint: 'از اولین خرید هر زیرمجموعه، این درصد به کیف پول معرف می‌رود. خریدهای تازهٔ بعدی پورسانت ندارند. صفر یعنی خاموش.',
    kind: 'int',
  },
  {
    scope: 'bot',
    key: 'affiliatespercentage_renewal',
    label: 'درصد پورسانت تمدید زیرمجموعه',
    hint: 'از هر تمدید هر زیرمجموعه — هر سرویسی و هر چند بار — این درصد به کیف پول معرف می‌رود. صفر یعنی خاموش.',
    kind: 'int',
  },
  {
    scope: 'shop',
