...
const TYPED_OUT_SETTINGS = [
  ...
  },
  {
    ...
    label: 'درصد پورسانت خرید اول زیرمجموعه',
    hint: 'از اولین خرید پولیِ هر زیرمجموعه، این درصد به کیف پول معرف می‌رود. خرید رایگان (مثلاً با کد ۱۰۰٪) خرید اول حساب نمی‌شود. خریدهای بعدی درصد تمدید را می‌گیرند. صفر یعنی خاموش.',
    kind: 'int',
  },
  {
    scope: 'bot',
    key: 'affiliatespercentage_renewal',
    label: 'درصد پورسانت تمدید و خریدهای بعدی زیرمجموعه',
    hint: 'از هر تمدید هر زیرمجموعه — هر سرویسی و هر چند بار — و از هر خرید تازه بعد از خرید اولش، این درصد به کیف پول معرف می‌رود. افزودنی (حجم و زمان اضافه) پورسانت ندارد. صفر یعنی خاموش.',
    kind: 'int',
  },
  {
    scope: 'shop',
  ...
  },
  {
    ...
    label: 'تخفیف یادآوری به نخریده‌ها (درصد)',
    hint: 'بیشتر از صفر که باشد، همراه یادآوری یک کد شخصیِ اولین خرید با این درصد ساخته می‌شود. صفر یعنی بدون کد.',
    kind: 'int',
  },
  {
    scope: 'bot',
    key: 'nudge_discount_days',
    label: 'اعتبار کد یادآوری (روز)',
    hint: 'کد شخصی از لحظهٔ ارسال یادآوری این تعداد روز اعتبار دارد.',
    kind: 'int',
  },
