...
import {
  ...
  pickLeastUsedCard,
  type CardBalancingCandidate,
} from '../src/cardBalancing.js';
...
describe('pickLeastUsedCard', () => {
  ...
  it('uses stable cardNumber tie-breaker', () => {
    const picked = pickLeastUsedCard([card('2222222222222222'), card('1111111111111111')]);
    expect(picked?.cardNumber).toBe('1111111111111111');
  });
});
