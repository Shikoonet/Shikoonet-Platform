...
'1','0','$status_cron'
        ...
        addFieldToTable("setting", "revenue_adjustment", "0", "BIGINT");
    }
} catch (Exception $e) {
    file_put_contents('error_log', $e->getMessage());
}
...
// revenue_adjustment_log table — used by panel/settings.php (Add/Deduct revenue) and panel/revenue_history.php
try {
    $pdo->exec("CREATE TABLE IF NOT EXISTS revenue_adjustment_log (
    ...
    file_put_contents('error_log revenue_adjustment_log', $e->getMessage());
}
