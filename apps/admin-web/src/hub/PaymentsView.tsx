      ...
      */}
      ...
      {canMessage && (
        <CustomerMessageSection
          listUrl="/api/v1/review-messages"
          saveUrl="/api/v1/admin/review-messages"
          sendUrl={`/api/v1/suspects/${item.id}/message`}
          messagedAt={item.messagedAt ?? null}
          messagedTemplate={item.messagedTemplate ?? null}
          writeProps={w}
          onSent={onRefresh}
          onError={onError}
        />
