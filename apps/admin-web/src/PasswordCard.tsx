    ...
    <form className="card" role="group" aria-label="تغییر رمز عبور" onSubmit={submit}>
      ...
      {done ? (
        <p className="alert alert-info">
          رمز عوض شد. هر نشست دیگری از این حساب — روی هر دستگاه دیگری — بسته شد؛ همین یکی باز
          ماند.
        </p>
      ) : (
        <>
          <p className="muted">
            دست‌کم ۱۲ کاراکتر و ۴ حرف متفاوت. اجبار حرف بزرگ و عدد و علامت عمداً نیست — چهار
            کاراکتر بیشتر از هر کدامشان می‌ارزد.
          </p>
