    ...
    <div className="modal-backdrop" onMouseDown={(e) => e.target === e.currentTarget && onClose()}>
      <div className="modal-body" onMouseDown={(e) => e.stopPropagation()}>
        ...
        <Fold title="⚙ تنظیمات پیشرفتهٔ پنل">
          ...
          <p className="muted" style={{ marginBlockStart: 4 }}>
            پنلِ شروع: هر کس <b>یک سرویس خریده باشد</b> دیگر این پنل را نمی‌بیند. «خرید کرده» یعنی
            سرویسی در اختیار دارد، نه اینکه سفارشی ثبت کرده باشد — و اکانت تست خرید حساب نمی‌شود.{' '}
            <b>
