  ...
  return (
    <div className="card" style={{ marginBlockStart: 12, borderColor: 'var(--accent)' }} data-testid="fresh-start">
      ...
      <p className="muted" style={{ marginBlockStart: 0 }}>
        دفتر هنوز باز نشده. روز شروع را انتخاب کن: موجودی هر حساب در نیمه‌شب آن روز — از آخرین پیامک
        بانک پیش از آن — موجودی اول می‌شود و جمعشان کیف پول فروشگاه در روز اول است. از آن روز به قبل هیچ
        درآمد و هزینه‌ای در هیچ گزارشی حساب نمی‌شود.
      </p>
      {walletNowIrr !== null && (
