/**
 * The panel's icons, inline.
 *
 * Inline SVG rather than an icon package: there are a dozen of them, they
 * never change, and a dependency plus a font file to draw twelve outlines is
 * more moving parts than the outlines. Every one inherits `currentColor`, so
 * the tone classes on the stat cards colour them for free.
 *
 * Written as JSX rather than as path strings fed through
 * `dangerouslySetInnerHTML`. The strings would be constants and safe today,
 * but the shape invites somebody to pass a variable into it later, and there
 * is no reason to leave that door open to save a few characters.
 */
...
const GLYPHS: Record<string, ReactNode> = {
  ...
  wallet: (
    <>
      ...
      <polyline points="22 12 18 12 18 16 22 16" />
      <path d="M2 10V6a2 2 0 0 1 2-2h14" />
    </>
  ),
  list: (
    <>
