...
describe('PaymentsView tabs', () => {
  ...
  it('lists Continuity deliveries separately and exposes their later-review audit facts', async () => {
    ...
    expect(screen.getByRole('region', { name: 'سابقه (تطبیق‌شده یا بسته‌شده)' })).toBeTruthy();
  ...
  it('paginates pending Continuity work and reconciled history independently', async () => {
    ...
    const history = await screen.findByRole('region', { name: 'سابقه (تطبیق‌شده یا بسته‌شده)' });
