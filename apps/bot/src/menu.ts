...
const REASON_TEXT_KEY: Record<string, TextKey> = {
  ...
  DISABLED: 'DISCOUNT_REFUSED_DISABLED',
...
export let RECEIPT_REMINDER = DEFAULT_TEXTS.raw('RECEIPT_REMINDER');
...
export function applyContent(content: BotContent): void {
  ...
  RECEIPT_REMINDER = t.raw('RECEIPT_REMINDER');
...
export const ASK_PREMIUM_EMOJI = [
  ...
  '',
  'یک پیام که فقط همان ایموجی(ها) در آن باشد. شناسه‌اش را از خودِ پیام برمی‌دارم —',
