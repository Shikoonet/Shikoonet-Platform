...
#
# `node:24-slim` is mutable: it moves whenever the Node 24 line gets a patch or
...
#
# sha256:2fe369e969550cde8e867afc3fe370b260140cab4a23d467074295b42163d553 is the
# OCI image index for `node:24-slim` (Node 24.21.0, the active LTS) as resolved
# on 2026-09-16 from
...
# and this image has neither — `node:24-slim` ships no HTTP client but Node
